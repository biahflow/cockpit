...
elas, os campos que apontavam para os dois (ADR 0052). O que a ADR **não** antecipou é a chave de
...
O alias da **`Evidencia`** não entra mais aqui: a classe legada saiu na Fase 6 (ADR 0052), junto do
dual-write, e o par do split (`Evidence`/`Finding`) nasceu já com o nome canônico, sem chave antiga
a proteger.
"""
...
from apps.core.models import ProcessStep, User
