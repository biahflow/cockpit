...
export function TeamPage() {
  ...
  return <section className="space-y-7">
    <header><p className="text-sm font-semibold text-ocean">Administração</p><h1 className="mt-1 text-3xl font-semibold tracking-tight text-ink">Equipe</h1><p className="mt-2 text-sm text-slate-600">Convide pessoas e acompanhe os acessos ao portal.</p></header>
    ...
    <div className="grid gap-5 lg:grid-cols-[.8fr_1.2fr]">
      <form className="space-y-4 rounded-2xl border bg-white p-5 sm:p-6" onSubmit={event => void invite(event)}>
        <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-mint text-ocean"><MailPlus className="size-5" /></span><div><h2 className="font-semibold text-ink">Convidar pessoa</h2><p className="text-sm text-slate-600">Um e-mail com o link de ativação será enviado.</p></div></div>
