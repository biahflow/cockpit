...
export function LoginPage() {
  ...
  return <div className="grid min-h-screen bg-canvas lg:grid-cols-[1.1fr_.9fr]">
    <section className="auth-brand hidden lg:flex lg:flex-col"><div className="absolute -right-16 top-16 size-72 rounded-full bg-brand-500/25 blur-sm" /><div className="absolute -bottom-24 -left-12 size-80 rounded-full border-[32px] border-white/10" /><a href="/" className="relative flex items-center gap-3"><PulseBrand tone="dark" subtitle={null} /></a><div className="relative my-auto max-w-lg"><p className="eyebrow eyebrow--dark mb-4">Operação Biahflow</p><p className="text-5xl font-semibold leading-tight tracking-tight">Clareza para vender, entregar e crescer.</p><p className="mt-6 max-w-md text-lg leading-8 text-white/75">A jornada inteira do cliente, do pipeline à execução, em uma visão que movimenta a operação.</p></div><p className="relative text-sm text-white/80">Biahflow · processos que fluem</p></section>
