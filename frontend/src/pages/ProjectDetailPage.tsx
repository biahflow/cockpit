...
import type { DigitalEmployee, DigitalEmployeeBlueprint, DigitalEmployeeStatus, GateOutcome, HealthAssessment, KpiDirection, KpiUnit, Meeting, Milestone, Party, Decisao, Pendencia, Project, ProjectMember, ProjectPhase, ProjectTimeline, Risco, RiscoNivel, RiscoStatus, RiskAssessment, Service, SessionUser, Task, WaitingParty, WorkItemStatus } from "../types";
