...
export type SignatureRequest = { id: number; signer_email: string; status: "pending" | "signed" | "declined"; reminded_at: string | null; signed_at: string | null; created_at: string };
