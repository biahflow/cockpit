  ...
  render(): ReactNode {
    ...
    return <main className="grid min-h-screen place-items-center bg-sand px-5 py-10">
      <div className="w-full max-w-lg rounded-3xl border bg-white p-7 shadow-xl shadow-ocean/5 sm:p-9">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-500">O erro já foi registrado. Recarregar costuma resolver; se voltar a acontecer, mande o código abaixo para quem cuida do portal.</p>
